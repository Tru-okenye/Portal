    ...
    if (isset($_POST['course'])) {
        ...
        if (isset($_POST['semester'])) {
            ...
            if (isset($_POST['unit'])) {
                ...
                // Fetch students based on selected filters (no mode of study filter)
...
<?php if (!empty($students)): ?>
    ...
    <form method="post" action="index.php?page=examinations/submit_attendance">
                ...
                <?php foreach ($students as $student): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Add hidden field for full_name -->
                        ...
                        <td>
                            ...
                            <!-- Add hidden field for unit_name -->
                            <input type="hidden" name="attendance[<?php echo htmlspecialchars($student['AdmissionNumber']); ?>][unit_name]" value="<?php echo htmlspecialchars($_POST['unit']); ?>">
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>

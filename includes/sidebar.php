   ...
   <div id="sidebar" class="sidebar">
        ...
        <div class="sidebar-content">
            ...
            <ul>
                <!-- Dropdown items -->
                <!-- <li class="dropdown">
                    <a href="index.php?page=admin_dashboard" class="dashboard-link">
                ...
                <ul class="dropdown-menu" data-dropdown="dashboard">
                    <li><a href="index.php?page=admin_dashboard">Home</a></li>
                </ul>
            </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" data-dropdown="academics">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" data-dropdown="students">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" data-dropdown="exams">
                        <li><a href="index.php?page=examinations/exam_attendance_form">Exam attendance form</a></li>
                        ...
                        <li><a href="index.php?page=examinations/supp_report">SuppAttendanceReport</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" data-dropdown="scripts">
                    <li><a href="index.php?page=examinations/slip_form">ResultsSlips</a></li>
                    <li><a href="index.php?page=transcripts/slip">View results</a></li>
                    <li><a href="index.php?page=examinations/transcript_form">Transcripts</a></li>
                    <li><a href="index.php?page=transcripts/transcript_form">View Transcripts</a></li>
                ...
                <ul class="dropdown-menu" data-dropdown="users">
                    <li><a href="index.php?page=users/users">Users</a></li>
                </ul>
            </li>
                <li class="dropdown">
                <button class="dropdown-btn">
                ...
                <ul class="dropdown-menu" data-dropdown="events">
                    <li><a href="index.php?page=communications/mailer">Send Email</a></li>
